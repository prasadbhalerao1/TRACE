...
export default function CandidateAssessmentsInboxPage() {
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      <div>
        <h1 className="text-2xl font-bold tracking-tight text-ink">My Assessments</h1>
        <p className="text-sm text-slate">Assessments recruiters have assigned to you.</p>
      </div>

      <Card>
        <CardHeader>
          <CardTitle className="text-base font-semibold">Assigned Assessments</CardTitle>
          <CardDescription>Open one to start or continue a coding challenge, quiz, or project review.</CardDescription>
        </CardHeader>
            ...
            >
              <div>
                ...
                <p className="text-xs text-slate mt-0.5">
                  Assigned on {new Date(assessment.created_at).toLocaleDateString()}
                </p>
              </div>
