    ...
    <div className="space-y-6 max-w-4xl mx-auto">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Test results, static analysis, and LLM code review for this
          submission.
        </p>
      </div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex flex-wrap gap-1.5">
                  {testResults.map((r) => (
                    <Badge
                      key={r.test_name}
                      variant={r.passed ? "secondary" : "outline"}
                      className="text-xs"
                    >
            ...
            {submission.llm_review && (
              <div className="space-y-2 border-t pt-3">
                ...
                <div className="grid grid-cols-2 gap-2 text-sm text-muted-foreground">
                  <span>
                    Readability:{" "}
                    {submission.llm_review.readability?.toFixed(0) ?? "—"}/100
                  </span>
                  <span>
                    Architecture:{" "}
                    {submission.llm_review.architecture?.toFixed(0) ?? "—"}/100
                  </span>
                </div>
