...
1. **Fine-tuned embeddings** — Currently BAAI/bge generic; could fine-tune on DataAxle's domain
...
- **DataAxle SRS 01 §7:** Career Guidance skill gap specification
- **DataAxle Doc 02:** Recruitment module vector search patterns
- **DataAxle Doc 08 §2:** Match score formula (embedding weights)
