...
async def _run_ingestion_and_persist(
    ...
    """Runs the Flow-A subgraph with existing profile data as the baseline, then
    persists the merged profile, a new talent_scores row, new badges, and an
    agent_runs explainability record (constraints.md §4)."""
